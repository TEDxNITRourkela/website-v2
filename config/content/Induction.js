...
export default {
    Message1:
      'You’ve successfully taken the first step to joining TEDxNITRClub! Please keep an eye on your Email ID for further details about the induction process.',
    Message2: 'Note: Check all your folders, spam and junk too.',
    TERMS: [
